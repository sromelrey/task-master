      ...
      <div className="max-w-4xl w-full space-y-8 text-center">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            A simple, beautiful task management app that helps you stay focused and productive. No
            sign-up required, your data stays private in your browser.
          </p>
        </div>
        ...
        <div className="pt-4">
          <p className="text-sm text-gray-500 dark:text-gray-500">
            🔒 Your data is stored locally in your browser. No servers, no tracking, complete
            privacy.
          </p>
        </div>
      </div>
